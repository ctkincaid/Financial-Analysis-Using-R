...
### **Introduction**
R is a powerful tool which can be used to perform robust analysis of financial data. This document demonstrates how to use R to import financial data, calculate returns over various time horizons, and measure a portfolio's risk.
